    ...
    <section class=todoapp>
        ...
        <footer class="footer" v-show="hasTodos">
            <span class="todo-count">
             <strong>{{ remaining }}</strong> Taches à faire</span>
             <ul class="filters">
                 <li><a href="#" :class="{selected: filter=== 'all'}" @click.prevent="filter = 'all'">Toutes</a></li>
                 <li><a href="#" :class="{selected: filter=== 'todo'}" @click.prevent="filter = 'todo'">A faire</a></li>
                 <li><a href="#" :class="{selected: filter=== 'done'}" @click.prevent="filter = 'done'">Faites</a></li>
             </ul>
             <button class="clear-completed" v-show="deleteTodos" @click="deleteCompleted">Supprimer terminées</button>
        </footer>
    </section>
...
<script>
    ...
    export default { 
        ...
        computed: {
            ...
            deleteTodos() {return this.todos.filter(todo=> todo.completed).length },
